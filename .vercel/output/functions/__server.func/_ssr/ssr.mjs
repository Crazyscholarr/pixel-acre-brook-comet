...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CfwJ8zAj.mjs");
...
var manifest = {
	"14b52626eda8b95bdc496340ef65713dbd5cac3d9642d461fe6c01d414593064": {
		functionName: "importUrlFn_createServerFn_handler",
		importer: () => import("./crawl-BVBz90L4.mjs")
	},
	"aede1963dd154b776522f8bfb78957a6184ca7df1723866116baf51820ce26d5": {
		functionName: "crawlSourceFn_createServerFn_handler",
		importer: () => import("./crawl-BVBz90L4.mjs")
	},
	"f5316b2630faed8cbcfe9879f22383498c290e71bba7d058d5b386e7a14e67aa": {
		functionName: "deepLocalizeFn_createServerFn_handler",
		importer: () => import("./localize-ai-BdNGa7Rk.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BkyD3Y34.mjs").then((n) => n.t),
